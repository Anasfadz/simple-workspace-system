...
@section('content')
    ...
    <!-- Hero Section -->
    <section class="bg-gradient-to-br from-emerald-50 to-teal-50 dark:from-gray-900 dark:to-gray-950 py-20">
        <div class="container mx-auto px-6">
            ...
            <div class="max-w-4xl fade-in-up">
                <h1 class="text-6xl md:text-7xl font-bold text-emerald-900 dark:text-emerald-400 mb-6 leading-tight">
                    Payment Gateway & <span class="text-emerald-600 dark:text-emerald-500">Laravel Developer</span>
                </h1>
                <p class="text-xl text-gray-700 dark:text-gray-300 mb-8 leading-relaxed max-w-3xl">
                    {{ $isMs
        ...
        : 'Experienced in building and integrating FPX and credit card payments, ensuring PCI-DSS compliance, improving performance for high-priority systems, and developing secure, scalable, and maintainable Laravel applications. Also skilled in API/Webhook integrations and server maintenance.' }}
                ...
                <div class="flex gap-4">
                    <a href="#projects"
                        class="bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-700 hover:to-teal-700 text-white font-semibold px-8 py-4 rounded-lg transition duration-300 shadow-lg">
                        {{ $isMs ? 'Lihat Projek' : 'View Projects' }}
                    </a>
                    <a href="#experience"
                        class="border-2 border-emerald-600 text-emerald-600 font-semibold px-8 py-4 rounded-lg hover:bg-emerald-50 transition duration-300">
    ...
    <section id="services" class="py-20 bg-white dark:bg-gray-900">
        <div class="container mx-auto px-6">
            <h2 class="text-5xl font-bold text-emerald-900 dark:text-emerald-400 mb-16">
                {{ $isMs ? 'Kepakaran' : 'Expertise' }}</h2>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-12">
                <div class="fade-in-up">
                    ...
                    <h3 class="text-2xl font-bold text-emerald-900 dark:text-emerald-300 mb-3">Payment Gateway</h3>
        ...
        : 'FPX & credit card integration, secure webhook handling, PCI-DSS compliance, error monitoring, and high reliability.' }}
                ...
                <div class="fade-in-up">
                    ...
                    <h3 class="text-2xl font-bold text-emerald-900 dark:text-emerald-300 mb-3">Laravel & PHP</h3>
                    <p class="text-gray-600 dark:text-gray-400">
                        {{ $isMs
        ...
        : 'Build secure, scalable modules; queues & caching; clean code standards; testing and documentation.' }}
                ...
                <div class="fade-in-up">
                    ...
                    <h3 class="text-2xl font-bold text-emerald-900 dark:text-emerald-300 mb-3">API & Webhooks</h3>
                    <p class="text-gray-600 dark:text-gray-400">
                        {{ $isMs
    ...
    <!-- Experience Section -->
    <section id="experience" class="py-20 bg-gray-50 dark:bg-gray-950">
        <div class="container mx-auto px-6">
            <h2 class="text-5xl font-bold text-emerald-900 dark:text-emerald-400 mb-12">
                {{ $isMs ? 'Pengalaman' : 'Experience' }}</h2>
            <div class="space-y-10">
                <!-- Simplepay Gateway -->
                <div class="bg-white dark:bg-gray-800 rounded-xl p-8 shadow-sm border dark:border-gray-700">
                    <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
                        <h3 class="text-2xl font-bold text-emerald-900 dark:text-emerald-300">
                            {{ $isMs ? 'Software Developer — Simplepay Gateway Sdn Bhd' : 'Software Developer — Simplepay Gateway Sdn Bhd' }}
                        </h3>
                        <span class="text-sm text-gray-500 dark:text-gray-400">Oct 2023 – Present</span>
                    </div>
                    ...
                    <div class="flex flex-wrap gap-2 mt-4">
                        <span
                            class="px-3 py-1 bg-emerald-50 dark:bg-emerald-900 text-emerald-700 dark:text-emerald-300 rounded-full text-sm">FPX</span>
                        <span
                            class="px-3 py-1 bg-emerald-50 dark:bg-emerald-900 text-emerald-700 dark:text-emerald-300 rounded-full text-sm">PCI-DSS</span>
                        <span
                            class="px-3 py-1 bg-emerald-50 dark:bg-emerald-900 text-emerald-700 dark:text-emerald-300 rounded-full text-sm">Laravel/PHP</span>
                    </div>
                </div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl p-8 shadow-sm border dark:border-gray-700">
                    ...
                    <div class="flex flex-wrap gap-2 mt-4">
                        <span
                            class="px-3 py-1 bg-emerald-50 dark:bg-emerald-900 text-emerald-700 dark:text-emerald-300 rounded-full text-sm">API</span>
                        <span
                            class="px-3 py-1 bg-emerald-50 dark:bg-emerald-900 text-emerald-700 dark:text-emerald-300 rounded-full text-sm">Webhook</span>
                        <span
                            class="px-3 py-1 bg-emerald-50 dark:bg-emerald-900 text-emerald-700 dark:text-emerald-300 rounded-full text-sm">Server/Hosting</span>
                    </div>
                </div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl p-8 shadow-sm border dark:border-gray-700">
                    ...
                    <div class="flex flex-wrap gap-2 mt-4">
                        <span
                            class="px-3 py-1 bg-emerald-50 dark:bg-emerald-900 text-emerald-700 dark:text-emerald-300 rounded-full text-sm">Laravel</span>
                        <span
                            class="px-3 py-1 bg-emerald-50 dark:bg-emerald-900 text-emerald-700 dark:text-emerald-300 rounded-full text-sm">Compliance</span>
                        <span
                            class="px-3 py-1 bg-emerald-50 dark:bg-emerald-900 text-emerald-700 dark:text-emerald-300 rounded-full text-sm">Accessibility</span>
                    </div>
                </div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl p-8 shadow-sm border dark:border-gray-700">
                    ...
                    <div class="flex flex-wrap gap-2 mt-4">
                        <span
                            class="px-3 py-1 bg-emerald-50 dark:bg-emerald-900 text-emerald-700 dark:text-emerald-300 rounded-full text-sm">CodeIgniter</span>
                        <span
                            class="px-3 py-1 bg-emerald-50 dark:bg-emerald-900 text-emerald-700 dark:text-emerald-300 rounded-full text-sm">REST
                            API</span>
                        <span
                            class="px-3 py-1 bg-emerald-50 dark:bg-emerald-900 text-emerald-700 dark:text-emerald-300 rounded-full text-sm">MySQL</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section id="projects" class="py-20 bg-white dark:bg-gray-900">
        <div class="container mx-auto px-6">
            <h2 class="text-5xl font-bold text-emerald-900 dark:text-emerald-400 mb-4">
                {{ $isMs ? 'Projek Terkini' : 'Recent Projects' }}</h2>
        ...
        : 'Focused on payment integrations, Laravel apps for government clients, retail dashboards, and custom systems.' }}
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div class="border dark:border-gray-700 rounded-xl p-6 hover:shadow-md transition">
                    <h3 class="text-xl font-semibold text-emerald-900 dark:text-emerald-300 mb-2">FPX & Credit Card Gateway
                    </h3>
